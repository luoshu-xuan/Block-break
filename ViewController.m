...
//{
//    //创建一个用来遮挡的view
//    UIView *_coverview = [[UIView alloc]initWithFrame:self.view.bounds];
//    //背景颜色给为黑色
...
//    _Message.text = [NSString stringWithFormat:@"%d",lastgrade];
//    //将其添加到遮罩view上
//    [self.view bringSubviewToFront:_Message];
//    [self.view bringSubviewToFront:_Exit];
//    [self.view bringSubviewToFront:_Restart];
//}
#pragma mark 重新开始游戏
- (void)Restartgame
{
